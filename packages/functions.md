...
### Sensors
  ...
  - [`useBeforetUnload`](https://vueuse.org/core/useBeforetUnload/) — reactive [Window: beforeunload event](https://developer.mozilla.org/en-US/docs/Web/API/Window/beforeunload_event)
